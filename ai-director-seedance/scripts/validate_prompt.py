#!/usr/bin/env python3
"""Basic validation for structured shot plans before prompt rendering."""
...
def main() -> int:
    ...
    if output_mode and output_mode not in {"storyboard_script", "final_prompt_only", "director_review"}:
        warnings.append("project: output_mode must be one of storyboard_script, final_prompt_only, director_review")
